// src/app/login/page.js (version 4.0)
'use client'
...
export default function PremiumLoginPortal() {
  ...
  const handleLogin = async (e) => {
    ...
    // No finally block, isLoading is handled on success path by navigation
  }
  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 z-0">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-cyan-500/5 rounded-full blur-2xl animate-pulse"
          ...
          <CardFooter className="px-8 pb-12">
            <Button
              ...
              className={cn(
                ...
                'disabled:bg-slate-700/50 disabled:text-slate-400 disabled:cursor-not-allowed disabled:scale-100 disabled:hover:shadow-none'
              )}
            >
