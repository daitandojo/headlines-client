// src/hooks/use-push-manager.js (version 2.0)
"use client";
...
export function usePushManager() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined' && 'serviceWorker' in navigator && 'PushManager' in window) {
            ...
            // Directly register the service worker generated by next-pwa
    ...
    const subscribe = useCallback(async () => {
        ...
        try {
            ...
            console.error("[PushManager] Error during push subscription:", error);
            if (error.name === 'NotAllowedError') {
                 toast.error("Permission denied.", { description: "You did not grant permission for notifications." });
            } else {
                 toast.error("Failed to enable notifications.", { description: "An unexpected error occurred." });
            }
            return false;
        } finally {
            setIsLoading(false);
